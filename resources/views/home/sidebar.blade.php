<div class="lg:w-1/3">
    ...
    <div class="bg-white rounded-xl p-6 mb-8">
        ...
        <div class="space-y-3">
            <a href="#" class="flex items-center justify-between hover:text-blue-600 transition duration-300">
                <span>Công nghệ</span>
                <span class="bg-gray-100 px-2 py-1 rounded text-sm">24</span>
            </a>
            <a href="#" class="flex items-center justify-between hover:text-blue-600 transition duration-300">
                <span>Kinh doanh</span>
                <span class="bg-gray-100 px-2 py-1 rounded text-sm">18</span>
            </a>
            <a href="#" class="flex items-center justify-between hover:text-blue-600 transition duration-300">
                <span>Thể thao</span>
                <span class="bg-gray-100 px-2 py-1 rounded text-sm">12</span>
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl p-6">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="#"
                class="bg-gray-100 hover:bg-gray-200 px-3 py-1 rounded-full text-sm transition duration-300">
                Technology
            </a>
            <a href="#"
                class="bg-gray-100 hover:bg-gray-200 px-3 py-1 rounded-full text-sm transition duration-300">
