    ...
    <div class="bg-white w-3/4 max-w-4xl mx-auto p-8 rounded-lg shadow-lg flex">
        <div class="w-1/2">
            ...
            <form method="post" action="{{ route('user.loginUser') }}">
                @csrf
                <div class="mb-4">
                    <input class="w-full p-3 bg-gray-200 rounded" placeholder="Tên tài khoản" type="text"
                        name="username" />
                ...
                <div class="mb-4 relative">
                    <input id="password" class="w-full p-3 bg-gray-200 rounded" placeholder="Mật Khẩu" type="password"
                        name="password" />
