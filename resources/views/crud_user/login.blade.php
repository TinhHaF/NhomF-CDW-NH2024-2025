    ...
    <div class="bg-white w-full max-w-3xl mx-auto p-8 rounded-lg shadow-lg fadeIn flex">
        ...
        <div class="w-1/2 pr-4">
            ...
            <form method="post" action="{{ route('user.loginUser') }}">
                @csrf
                <div class="mb-4">
                    <input class="w-full p-3 bg-gray-200 rounded shadow-sm input-focus transition duration-200" placeholder="Tên tài khoản" type="text"
                ...
                <div class="mb-4 relative">
                    <input id="password" class="w-full p-3 bg-gray-200 rounded shadow-sm input-focus transition duration-200" placeholder="Mật Khẩu" type="password"
        ...
        <div class="w-1/2 pl-4 flex flex-col items-center justify-center"> <!-- Thay đổi layout để căn giữa -->
