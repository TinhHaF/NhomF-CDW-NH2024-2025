    ...
    <div class="max-w-4xl mx-auto p-4 bg-white shadow-lg rounded-lg mt-10">
        <div class="flex justify-between items-center border-b pb-2 mb-4">
            ...
            <form action="{{ route('home')  }}">
                ...
                <button type="submit">
                    <i
                        class="fas fa-sign-out-alt text-xl cursor-pointer hover:text-red-500 transition duration-300"></i>
                </button>
            </form>
        </div>
        <div class="flex">
            ...
            <div class="w-1/2 pl-4">
                ...
                <div class="mb-4">
                    <form action="{{ route('user.logout')}}">
                        @csrf
                        <button type="submit"
                            class="bg-gray-300 w-full py-2 rounded-lg hover:bg-gray-400 transition duration-300">
                            Đăng Xuất Tài Khoản
                        </button>
                    </form>
                </div>
