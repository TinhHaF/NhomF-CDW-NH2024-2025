    ...
    <div class="bg-white w-3/4 max-w-4xl mx-auto p-8 rounded-lg shadow-lg flex">
        <div class="w-1/2">
            <div class="flex justify-between items-center mb-8">
                <button class="text-gray-500 flex-1 text-center">Đăng Nhập</button>
            ...
            <form method="post" action="{{ route('user.addUser') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                    <input class="w-full p-3 bg-gray-200 rounded" placeholder="Tên tài khoản" type="text" id="name" name="name" />
                    @if ($errors->has('name'))
